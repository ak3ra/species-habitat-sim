setwd("/home/akera/comp599/species-habitat-sim")
...
print("2. CALCULATING LANDCOVER WITHIN RADIUS")
...
print("2.1: landcover 100m")
lc100 <- raster::extract(rs, x, buffer = 100, small = TRUE)
print("2.1: landcover 250m")
lc250 <- raster::extract(rs, x, buffer = 250, small = TRUE)
print("2.1: landcover 500m")
lc500 <- raster::extract(rs, x, buffer = 500, small = TRUE)

print("Finished creating landcover radii")

print("3. ### Forest cover in 100m radius")
...
print("### Forest cover in 250m radius")
